class TasksController < ApplicationController
  ...
  def new
      @taskcategory= ['Proposal','Project Management','Briefing','Desk Research or Data Mining','Discussion Guide','Interim','Debrief','Synthesis and Opportunity Mapping','Workshop','Travel','Non-Job']
  end
